...
def write_geojson_polynomials_from_tif_to_file(tif_filename, plot_polynomials: bool = False) -> None:
    """Write tif file to geojson file.
    ...
    gdf.to_file(tif_filename[:-4] + ".geojson", driver="GeoJSON")
...
if __name__ == "__main__":
    ...
    write_geojson_polynomials_from_tif_to_file(filename, plot_polynomials=True)